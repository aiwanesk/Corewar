...
t_arg parsing_request(t_process *p, unsigned char memory[MEM_SIZE]);
...
void				apply_and(t_process *process, unsigned char memory[MEM_SIZE], t_arg arg);
void				apply_or(t_process *process, unsigned char memory[MEM_SIZE], t_arg arg);
void				apply_xor(t_process *process, unsigned char memory[MEM_SIZE], t_arg arg);

void				apply_add(t_process *process, unsigned char memory[MEM_SIZE], t_arg arg);
void				apply_sub(t_process *process, unsigned char memory[MEM_SIZE], t_arg arg);

void				apply_ld(t_process *process, unsigned char memory[MEM_SIZE], t_arg arg);
